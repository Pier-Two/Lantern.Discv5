...
public class RlpDecoderTest
{
    ...
    public static void Decode(RlpMessage msg)
    {
    ...
    public static void DecodeSingleByte(RlpMessage msg)
    {
        msg.Data.Add(new[] { msg.Remainder.Array![msg.Remainder.Offset] });
        msg.Remainder = msg.Remainder[1..];
    }

    public static void DecodeString(RlpMessage msg)
    {
        var itemLength =
    ...
    public static void DecodeShortCollection(RlpMessage msg)
    {
        var listLength =
    ...
    public static void DecodeCollection(RlpMessage msg)
    {
    ...
    public static void DecodeLongCollection(RlpMessage msg)
    {
