...
public class EnrTests
{
    ...
    public void Test_ConvertEnrRecordToEnrString_ShouldConvertCorrectly()
    {
        ...
        var entries = new Dictionary<string, IContentEntry>
        {
            { EnrContentKey.Id, id },
            { EnrContentKey.Ip, ip },
            { EnrContentKey.Secp256K1, pubKey },
            { EnrContentKey.Udp, udp }
        };

        var enr = new EnrRecord(entries,new IdentitySchemeV4Verifier(),null, signature);
    ...
    public void Test_EnrStringSerialization_ShouldDecodeCorrectly()
    {
        var enrString =
            "enr:-IS4QHCYrYZbAKWCBRlAy5zzaDZXJBGkcnh4MHcBFZntXNFrdvJjX04jRzjzCBOonrkTfj499SZuOh8R33Ls8RRcy5wBgmlkgnY0gmlwhH8AAAGJc2VjcDI1NmsxoQPKY0yuDUmstAHYpMa2_oxVtw0RW_QAdpzBQA8yWM0xOIN1ZHCCdl8";
        var enr = new EnrRecordFactory().CreateFromString(enrString, new IdentitySchemeV4Verifier());
        var signature =
            Convert.FromHexString(
                "7098ad865b00a582051940cb9cf36836572411a47278783077011599ed5cd16b76f2635f4e234738f30813a89eb9137e3e3df5266e3a1f11df72ecf1145ccb9c");
    ...
    public void Test_V4IdentitySchemeSigning_ShouldSignContentCorrectly()
    {
        var enr = new EnrRecordFactory().CreateFromString(
            "enr:-IS4QHCYrYZbAKWCBRlAy5zzaDZXJBGkcnh4MHcBFZntXNFrdvJjX04jRzjzCBOonrkTfj499SZuOh8R33Ls8RRcy5wBgmlkgnY0gmlwhH8AAAGJc2VjcDI1NmsxoQPKY0yuDUmstAHYpMa2_oxVtw0RW_QAdpzBQA8yWM0xOIN1ZHCCdl8", new IdentitySchemeV4Verifier());
    ...
    public void Test_V4PeerIdGeneration_ShouldDerivePeerIdCorrectly()
    {
        ...
        var enr2 = new EnrRecordFactory().CreateFromString("enr:-Ku4QImhMc1z8yCiNJ1TyUxdcfNucje3BGwEHzodEZUan8PherEo4sF7pPHPSIB1NNuSg5fZy7qFsjmUKs2ea1Whi0EBh2F0dG5ldHOIAAAAAAAAAACEZXRoMpD1pf1CAAAAAP__________gmlkgnY0gmlwhBLf22SJc2VjcDI1NmsxoQOVphkDqal4QzPMksc5wnpuC3gvSC8AfbFOnZY_On34wIN1ZHCCIyg", new IdentitySchemeV4Verifier());
