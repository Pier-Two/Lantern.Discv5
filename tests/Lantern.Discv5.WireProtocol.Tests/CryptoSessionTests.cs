...
public class CryptoSessionTests
{
    ...
    public void Test_IdSignatureGeneration_ShouldCreateSignatureCorrectly()
    {
        ...
        var signature = SessionCrypto.GenerateIdSignature(sessionKeys, challengeData, emphemeralPubkey, nodeBId);
    ...
    public void Test_IdSignatureVerification_ShouldVerifySignatureCorrectly()
    {
        ...
        var result = SessionCrypto.VerifyIdSignature(signature, challengeData,sessionKeys.PublicKey, emphemeralPubkey, nodeBId, Context.Instance);
