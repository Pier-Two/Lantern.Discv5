...
public class PacketTests
{
    ...
    public void Test_HandshakePacket_ShouldGenerateCorrectly()
    {
        ...
        var nodeACrypto = new CryptoSession(new SessionKeys(nodeAPrivKey, nodeAEphemeralPrivKey), SessionType.Recipient);
        var nodeAEphemeralPubkey = nodeACrypto.EphemeralPublicKey;
        var nodeBPubkey =
            new CryptoSession(new SessionKeys(Convert.FromHexString("66fb62bfbd66b9177a138c1e5cddbe4f7c30c343e94e68df8769459cb1cde628")), SessionType.Recipient).PublicKey;
        var nonce = Convert.FromHexString("ffffffffffffffffffffffff");
        var maskedIv = Convert.FromHexString("00000000000000000000000000000000");
    ...
    {
        var nodeAPubkey = new CryptoSession(new SessionKeys(Convert.FromHexString("eef77acb6c6a6eebc5b363a475ac583ec7eccdb42b6481424c60f59aa326547f")), SessionType.Initiator).PublicKey;
        var nodeBId = Convert.FromHexString("bbbb9d047f0488c0b5a93c1c3f2d8bafc7c8ff337024a55434a0d0555de64db9");
        var nodeBCrypto = new CryptoSession(new SessionKeys(Convert.FromHexString("66fb62bfbd66b9177a138c1e5cddbe4f7c30c343e94e68df8769459cb1cde628")), SessionType.Recipient);
