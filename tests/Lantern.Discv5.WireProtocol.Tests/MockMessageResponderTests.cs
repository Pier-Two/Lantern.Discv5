...
public class MockMessageResponderTests
{
    ...
    public async Task Test_HandlePongMessage_ShouldReturnNull_WhenPendingRequestIsNotAvailable()
    {
        ...
        var messageResponder = new MessageResponder(mockIdentityManager.Object, mockRoutingTable.Object, mockRequestManager.Object, mockLookupManager.Object, mockMessageDecoder.Object, mockLoggerFactory.Object);
        ...
        mockRoutingTable.Verify(x => x.GetNodeEntry(It.IsAny<byte[]>()), Times.Never);
    }
    ...
    public async Task Test_HandlePongMessage_ShouldReturnNull_WhenNodeEntryIsNull()
    {
        ...
        mockRoutingTable.Verify(x => x.UpdateFromEnr(It.IsAny<EnrRecord>()), Times.Never);
    }
    ...
    public async Task Test_HandlePongMessage_ShouldUpdateNode_WhenNodeStatusIsNotLive()
    {
        ...
        mockRoutingTable
            ...
            .Returns(new NodeTableEntry(enr, new IdentitySchemeV4Verifier()));
        mockIdentityManager
