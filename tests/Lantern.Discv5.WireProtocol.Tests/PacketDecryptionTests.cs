...
public class PacketDecryptionTests
{
    ...
    public void Test_OrdinaryPacket_ShouldGeneratePacketCorrectly()
    {
        ...
        var encryptedHeader = maskedHeader.GetMaskedHeader(staticHeader.GetHeader(), AesCrypto);
    ...
    public void Test_OrdinaryPacket_ShouldDecryptPacketCorrectly()
    {
        ...
        var decryptedData = AesCrypto.AesCtrDecrypt(nodeBId[..16], ordinaryPacket[..16],ordinaryPacket[16..]);
    ...
    public void Test_HandshakePacket_ShouldGenerateCorrectly()
    {
        ...
        var encryptedMessage = AesCrypto.AesGcmEncrypt(sessionKeys.InitiatorKey, nonce, messagePt, messageAd);
        var packet = ByteArrayUtils.Concatenate(maskedIv, maskedHeader.GetMaskedHeader(staticHeader.GetHeader(), AesCrypto), encryptedMessage);
